 ...
 *
 */
@Action(url="guild/group/user/get_receive_notify")
public class GuildGroupUserGetReceiveNotifyAction extends AbstractActionExecutor
{
	...
	{
		return logic.getReceiveNotify(context);
	}
}